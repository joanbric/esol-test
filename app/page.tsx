            ...
            <div className="grid gap-12 lg:grid-cols-2 items-center">
              <div className="space-y-8 max-w-2xl">
                ...
                <p className="text-xl text-gray-600 max-w-3xl">
                  Practise with our comprehensive collection of ESOL exam
                  materials. Get instant feedback and improve your skills with
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-4xl font-extrabold text-gray-900 mb-4">
                Features Designed for ESOL Students
              </h2>
              <p className="text-xl text-gray-600">
                Everything you need to prepare for your ESOL exams in one place.
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
              <div className="bg-white rounded-3xl shadow-xl p-8 transform hover:scale-105 transition-transform">
                ...
                <p className="text-gray-600">
                  Access a wide range of practice tests covering all ESOL exam
              ...
              <div className="bg-white rounded-3xl shadow-xl p-8 transform hover:scale-105 transition-transform">
                ...
                <p className="text-gray-600">
                  Receive detailed feedback on your performance with suggestions
                  for improvement.
                </p>
              </div>
              <div className="bg-white rounded-3xl shadow-xl p-8 transform hover:scale-105 transition-transform">
                ...
                <p className="text-gray-600">
                  Get customised study plans based on your strengths and
                  weaknesses.
                </p>
              </div>
            </div>
        ...
        <section id="how-it-works" className="py-24 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-xl text-gray-600">
                Simple steps to improve your English skills and pass your ESOL
                exams.
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Take practice tests that match your level and get instant
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Follow your personalised study plan and track your progress
                  over time.
                </p>
              </div>
            </div>
        ...
        <section id="testimonials" className="py-24 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-xl text-gray-600">
                Hear from students who have improved their English skills with
                our platform.
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
              <div className="bg-white rounded-3xl shadow-xl p-8 relative">
                ...
                <q className="text-gray-700 mb-8 text-lg">
                  This platform helped me pass my ESOL exam with confidence.
                  The practice tests were very similar to the actual exam.
                </q>
              ...
              <div className="bg-white rounded-3xl shadow-xl p-8 relative">
                ...
                <q className="text-gray-700 mb-8 text-lg">
                  The feedback I received after each practice test was
                  incredibly helpful. I could see my progress week by week.
                </q>
                <div className="flex items-center gap-4">
                  <div className="rounded-full bg-emerald-100 p-4 h-14 w-14 flex items-center justify-center">
                    <span className="text-emerald-600 font-bold text-xl">
              ...
              <div className="bg-white rounded-3xl shadow-xl p-8 relative">
                ...
                <q className="text-gray-700 mb-8 text-lg">
                  As a beginner, I was worried about learning English, but this
                  platform made it easy and enjoyable.
                </q>
                <div className="flex items-center gap-4">
                  <div className="rounded-full bg-emerald-100 p-4 h-14 w-14 flex items-center justify-center">
                    <span className="text-emerald-600 font-bold text-xl">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-xl mb-10 text-emerald-100">
                Join thousands of students who have passed their ESOL exams with
                our platform.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-10">
            <div className="space-y-6">
              ...
              <p className="text-gray-400 max-w-xs">
                Helping ESOL students achieve their language learning goals
                through comprehensive practice and personalised feedback.
              </p>
            </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400">
              &copy; {new Date().getFullYear()} ESOL Practise. All rights
              reserved.
            </p>
